...
├── packages/
│   └── indexer/          # Envio数据索引器
├── docs/                 # 📚 项目文档（30份文档，已分类整理）
│   ├── 01-planning/      # 规划文档（PRD、开发计划等）
│   ├── 02-guides/        # 使用指南（快速开始、部署等）
│   ├── 03-status-reports/# 状态报告
│   ├── 04-setup/         # 配置设置
│   ├── 05-debug-logs/    # 调试记录
│   └── 06-summaries/     # 项目总结
├── scripts/              # 🔧 开发和测试脚本
│   ├── quick-test.sh     # 快速测试API功能
...
**脚本功能：**
- `test-setup.sh`: 检查 Node.js、pnpm、Envio 安装状态，验证环境配置
- `quick-test.sh`: 启动 API 并测试基本端点（/health, /api/price/pyusd）

详见 `scripts/README.md` 了解更多用法。
